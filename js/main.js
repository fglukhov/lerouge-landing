...
$(document).ready(function() {
	...
	$(".section-top-arrow").click(function () {

		$("html,body").animate({
			scrollTop: $(".section-show").offset().top - 72
		}, 1500);
...
function makeUp () {
	...
	$(".actions-slider .slick-arrow").css({
		bottom: $(".action-tmb-pic img").height() / 2
	});
